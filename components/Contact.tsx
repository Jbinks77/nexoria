        ...
        <form onSubmit={handleSubmit} className="glass-card p-6" noValidate>
          <div className="grid gap-4">
            ...
            <label className="grid gap-1.5 text-sm" htmlFor="budget">
              Budget
              <select id="budget" name="budget" required className="rounded-xl border border-border bg-white px-3 py-2">
                <option value="">Sélectionner…</option>
                <option>- 1000€</option>
            ...
            <label className="grid gap-1.5 text-sm" htmlFor="message">
              Message
              <textarea id="message" name="message" rows={5} required className="rounded-xl border border-border bg-white px-3 py-2" />
            </label>
            <button type="submit" className="mt-2 rounded-full bg-violet px-5 py-3 font-semibold text-white transition hover:-translate-y-0.5">
              Envoyer
            </button>
            {success && (
